...
Can You Help?
Links to Good Stuff
Update History and Errors Corrected
Information Nuggets
How to Contact Me
About the Author
...
### 3WIRE.ZIP
(~30 Kbytes)
07/14/05	Calculates the best wire size and measurement over wires when using the three wire method to check the pitch diameter of a thread.
